...
bool SnmpGet(struct host *hp, const char *oid_names, int oid_length, string &ret_string)
{
...
double GetCpuUsage(struct host *host_info)
{
    string ret_string;
    if (SnmpGet(host_info, ".1.3.6.1.4.1.2021.11.11.0", 25, ret_string))
    {
...
int main()
{
    ...
    cerr << "GetCpuUsage:" << GetCpuUsage(&host_info) << endl;
